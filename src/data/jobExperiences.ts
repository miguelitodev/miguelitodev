...
export const experiences: Experience[] = [
  {
    companyName: "Qintess",
    companyLocation: "Brazil · Remote",
    position: "Frontend Developer (Mid-Level)",
    duration: "Mar 2025 - Present",
    description:
      "I have started working as a Mid-Level Frontend Developer at Qintess, a global technology company specializing in accelerating digital transformation for businesses. Qintess operates in 9 countries, serving over 800 clients in 14 cities worldwide, standing out as a leader in innovation and technology solutions that drive companies into the future.\n\nInitially, I am assigned to the Ministério Público da Bahia, a client of Qintess, contributing to the development and maintenance of systems using technologies such as React, TypeScript, Redux, and JavaScript. After completing this project, I may be reassigned to others based on new project demands and clients.",
  },
  {
    companyName: "Ministério Público do Estado da Bahia",
    companyLocation: "Bahia, Brazil · Remote",
    position: "Frontend Developer (via Qintess)",
    duration: "Mar 2025 - Present",
    description:
      "At the Ministério Público da Bahia, my work is focused on developing and maintaining internal systems using technologies such as React, TypeScript, Redux, and JavaScript. The goal is to enhance digital infrastructure and ensure efficient, user-friendly applications. After completing this project, I may be reassigned to other initiatives within Qintess.",
  },
  {
