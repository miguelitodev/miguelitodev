import { fetchRepos } from "./fetchRepos"; // Função para buscar os repositórios
...
export default async function Projects() {
	// Busca os dados de repositórios de forma estática
	const repos = await fetchRepos("miguelitodev");
...
// Use `generateStaticParams` para o App Router
export function generateStaticParams() {
	return [{ params: { page: "projects" } }];
}
